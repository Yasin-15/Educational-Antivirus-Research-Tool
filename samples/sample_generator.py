...
class SampleGenerator:
    ...
    def create_eicar_sample(self, filename: Optional[str] = None) -> SampleInfo:
        ...
        try:
            ...
            import hashlib
            file_hash = hashlib.sha256(eicar_string.encode()).hexdigest()
            file_size = len(eicar_string.encode())
            ...
            return SampleInfo(
                ...
                file_hash=file_hash,
                file_size=file_size,
                educational_notes="This is the industry-standard test file used to verify antivirus functionality."
            )
    ...
    def create_custom_signature_sample(self, signature_name: str, filename: Optional[str] = None) -> SampleInfo:
        ...
        try:
            ...
            return SampleInfo(
                ...
                file_hash=file_hash,
                file_size=file_size,
                educational_notes=f"Contains {signature_name} signature pattern for testing signature-based detection."
            )
    ...
    def create_behavioral_trigger_sample(self, trigger_type: str, filename: Optional[str] = None) -> SampleInfo:
        ...
        try:
            ...
            return SampleInfo(
                ...
                file_hash=file_hash,
                file_size=file_size,
                educational_notes=f"Designed to trigger {trigger_type} behavioral analysis patterns."
            )
